...
facebook.addEventListener('click', () => {
  ...
  div.innerHTML = `<iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fpg%2FModernEspaiGospelCor%2Fposts%2F&tabs=timeline&width=500&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="500" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture;"></iframe>`;
  box.appendChild(div);
});
instagram.addEventListener('click', () => {
  ...
  data-instgrm-permalink="https://www.instagram.com/p/CZfDjDbMCfd/?utm_source=ig_embed&amp;utm_campaign=loading"
...
>
  <div style="padding: 16px">
    <a
      href="https://www.instagram.com/p/CZfDjDbMCfd/?utm_source=ig_embed&amp;utm_campaign=loading"
      style="
        background: #ffffff;
        line-height: 0;
        padding: 0 0;
    ...
    >
      <a
        ...
        "
        target="_blank"
        >Una publicación compartida de Megòc (@modernespaigospelcor)</a
      >
    </p>
  </div>
</blockquote>
...
youtube.addEventListener('click', () => {
  ...
  div.setAttribute('id', 'red');
  div.innerHTML =
    '<iframe width="560" height="315" src="https://www.youtube.com/embed/15Jzey8k7B0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
  box.appendChild(div);
});
